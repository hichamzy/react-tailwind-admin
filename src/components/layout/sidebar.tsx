    ...
    <>
            ...
            >
              <DialogPanel className="relative mr-16 flex w-full max-w-xs flex-1">
                ...
                <div className="flex grow flex-col gap-y-5 overflow-y-auto bg-blue-800 px-6 pb-4 ring-1 ring-white/10">
                  <div className="flex h-16 shrink-0 flex-col items-center justify-stretch">
                    <img
                                  ...
                                  {({ open }) => (
                                    <>
                                      ...
                                      <DisclosurePanel
                                        as="ul"
                                        transition
                                        className="mt-1 origin-top px-2 transition duration-200 ease-out data-[closed]:-translate-y-6 data-[closed]:opacity-0"
                                      >
      ...
      <div className="hidden lg:fixed lg:inset-y-0 lg:z-50 lg:flex lg:w-72 lg:flex-col">
        ...
        <div className="flex grow flex-col gap-y-5 overflow-y-auto bg-blue-800 px-6 pb-4">
          <div className="h-45px m-22 flex h-16 shrink-0 flex-col items-center justify-stretch">
            <img
              style={{ height: "45px", width: "auto", margin: "10px" }}
              className="h-8 w-auto"
              src="../public/media/logos/logo.svg"
                        ...
                        >
                          {({ open }) => (
                            <>
                              <DisclosureButton
                                className={classNames(
                                  item.children.some((i) => i.href === pathname)
                                    ? "text-white"
                                    : "text-gray-400 hover:text-white",
                                  "flex w-full items-center gap-x-3 rounded-md p-2 text-left text-sm font-semibold leading-6",
                                )}
